...
contract('NetworkManager', function ([account0, account1, account2]) {
    let networkManager;
    ...
    it('create networks', async function () {
        ...
        let networkContract = new Network(networkContractAddress);
        ...
        networkContract = new Network(networkContractAddress);
        assert.equal(await networkContract.getPeerCount(), 0);
